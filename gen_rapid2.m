...
for i=1:n_rtar
    ...
    if i == 1
        if nargin == 4
            mov = mov_gen2('J',name,vel(1),0);
        elseif nargin == 5
            mov = mov_gen2('J',name,vel(1),zone);
        elseif nargin == 6
            mov = mov_gen2('J',name,vel(1),zone,tool);
        else
            mov = mov_gen2('J',name,1000,0);
        end
    else
        if nargin == 4
            mov = mov_gen2('L',name,vel(2),0);
        elseif nargin == 5
            mov = mov_gen2('L',name,vel(2),zone);
        elseif nargin == 6
            mov = mov_gen2('L',name,vel(2),zone,tool);
        else
            mov = mov_gen2('L',name);
        end
    end
